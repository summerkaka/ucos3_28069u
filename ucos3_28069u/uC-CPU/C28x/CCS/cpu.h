...
*                                                   memory address after data is pushed onto the stack
*
*           (2) Configure CPU_CFG_STK_ALIGN_BYTES with the highest minimum alignment required for
*               cpu stacks.
*********************************************************************************************************
*/
...
void      CPU_IntSrcDis    (CPU_DATA  bit);                     /* Disable specific interrupt source.                   */
void      CPU_IntSrcEn     (CPU_DATA  bit);                     /* Enable  specific interrupt source.                   */
void      CPU_IntSrcPendClr(CPU_DATA  bit);                     /* Clear   specific pending interrupt.                  */

CPU_SR    CPU_SR_Save      (void);                              /* Save    CPU status word & disable interrupts.        */
void      CPU_SR_Restore   (CPU_SR    cpu_sr);                  /* Restore CPU status word.                             */

CPU_DATA  CPU_RevBits      (CPU_DATA  val);                     /* Reverse the bits in a data value.                    */
