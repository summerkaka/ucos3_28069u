...
struct I2CMSG {
  Uint16 Status;             // Word stating what state msg is in:
  ...
  Uint16 ErrNum;              // Counter for NOT_READY_ERROR and BUSY_ERROR
  Uint16 NackNum;              // Counter for NACK times
  Uint16 DevAddr;            // I2C address of slave msg is intended for
  union UWD RegAddr;
